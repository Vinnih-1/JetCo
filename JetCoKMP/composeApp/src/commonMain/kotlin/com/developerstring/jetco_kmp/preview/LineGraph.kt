...
import com.developerstring.jetco_kmp.charts.linegraph.MultiLineGraph
...
import com.developerstring.jetco_kmp.charts.linegraph.model.LineGraphSeries
import com.developerstring.jetco_kmp.charts.candlestickchart.CandlestickChart
...
/**
 * Formats a Float value to exactly 2 decimal places.
 * Pure Kotlin implementation for Multiplatform compatibility.
 */
private fun formatTo2Decimals(value: Float): String {
    if (value.isNaN() || value.isInfinite()) return "0.00"
    val negative = value < 0f
    val absRounded = kotlin.math.round(kotlin.math.abs(value) * 100).toLong()
