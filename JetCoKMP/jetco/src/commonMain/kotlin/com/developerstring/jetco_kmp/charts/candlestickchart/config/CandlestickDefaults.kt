...
package com.developerstring.jetco_kmp.charts.candlestickchart.config
...
/**
 * Factory functions with sensible defaults for the [com.developerstring.jetco_kmp.charts.candlestickchart.CandlestickChart].
 *
 * Example:
 * ```
 * CandlestickChart(
